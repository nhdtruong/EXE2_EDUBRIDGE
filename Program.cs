...
namespace EduBridge
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<EduBridge.Services.ImportExportHistories.IImportExportHistoryService, EduBridge.Services.ImportExportHistories.ImportExportHistoryService>();
