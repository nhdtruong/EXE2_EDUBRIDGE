...
PRINT N'Bo qua block du lieu test nhieu lop trong migration 20260527_001. Du lieu test phai nam o script seed rieng.';
GO
...
BEGIN
    PRINT N'Bo qua phan chuan hoa Courses trong migration 20260527_001 vi bang dbo.Courses khong ton tai.';
END;
GO
